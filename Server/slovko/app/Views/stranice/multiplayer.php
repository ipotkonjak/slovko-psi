                    ...
                    <div class="keyboard-wrap">
                        <div id="keyboard">
                            ...
                            <div id="dugmici" style="margin-top: 1em;">
                                <button type="button" class="btn btn-dark btn-rounded" onclick="traziProtivnika()" style="text-align: center" id="igraj">Тражи новог противника</button>
                                &emsp;&emsp;&emsp;&emsp;
                                <button type="button" class="btn btn-dark btn-rounded" onclick="cancel()" style="text-align: center" id="igraj">Одустани</button>
                            </div>
